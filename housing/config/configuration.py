...
class Configuration:
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        try:
            ...
            data_ingetion_artifact_dir= os.path.join(
                artifact_dir,
            ...
            tgz_download_dir= os.path.join(
                data_ingetion_artifact_dir, data_ingestion_info[DATA_INGESTION_TGZ_DOWNLOAD_DIR_KEY]
            )
            
            row_data_dir= os.path.join(
                data_ingetion_artifact_dir,
    ...
    def get_data_transformation_config(self)-> DataTransformationConfig:
        try:
            artifact_dir= self.training_pipeline_config.artifat_dir
            data_transformation_artifact_dir= os.path.join(
                artifact_dir,
                DATA_TRANSFROMAION_ARTIFACT_DIR,
                self.time_stamp
            )
            ...
            logging.info(f"Preprocessed file path: {preprocessed_object_file_path}, Transformed train file path: {transformed_train_dir}, Transformed test file dir: {transformed_test_dir}")
            logging.info(f"Data Tranformation Configuration Completed")
    ...
    def get_training_pipeline_config(self) -> TrainingPipelineConfig:
        try:
            ...
            training_pipeline_config[TRAINING_PIPELINE_CONFIG_NAME],
            training_pipeline_config[TRAINING_PIPELINE_CONFIG_DIR]
            )
