...
class DataValidation:
    ...
    def is_train_test_file_exists(self):
        """It will check whether train and test files are created in the folder"""
        try:
            logging.info("Cheking train test files")
            ...
            if not is_available:
                ...
                message= f"Testing file: {test_file} or training_file: {train_file} is not present at dir"
